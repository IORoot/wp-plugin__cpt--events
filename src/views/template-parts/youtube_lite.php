...
<?php 
    ...
    if (empty($videoId)){
        ...
        echo '<lite-youtube class="lazyload w-full h-80 mb-24 block bg-cover bg-center bg-no-repeat bg-night fill-youtube flex cursor-pointer"  id="ytplayer"  videoid="'. $videoId .'" >' . PHP_EOL;
